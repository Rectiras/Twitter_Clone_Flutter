...
class ProfilePrivPage extends StatefulWidget {

  ProfilePrivPage({Key key, this.analytics, this.observer}) : super(key: key);

  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  @override
  _ProfilePrivPageState createState() => _ProfilePrivPageState();
}

class _ProfilePrivPageState extends State<ProfilePrivPage> {
